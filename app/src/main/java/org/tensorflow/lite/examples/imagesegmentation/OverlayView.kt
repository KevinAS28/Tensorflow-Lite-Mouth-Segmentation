        ...
        if (segmentResult != null && segmentResult.isNotEmpty()) {
            ...
            for (i in maskArray.indices) {
                ...
                if (!pixelCounts.containsKey(pixelClassification)){
                    ...
                    pixelCounts.put(pixelClassification, (pixelCounts.get(pixelClassification)!!)+1)
                }
            ...
            var borderCount = if(pixelCounts.containsKey(2)) pixelCounts.get(2) else 0
            var objectCount = if(pixelCounts.containsKey(0)) pixelCounts.get(0) else 0
            var backgroundCount = if(pixelCounts.containsKey(1)) pixelCounts.get(1) else 0
            var scale = 4.5;
